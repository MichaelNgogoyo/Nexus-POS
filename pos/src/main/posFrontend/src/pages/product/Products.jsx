...
function Products() {
    ...
    return (
        <div className="min-h-screen bg-gray-200 py-10 px-4">
            ...
            <div>
                <NavLink to={ROUTES.CREATEPRODUCT} >Add New Product</NavLink>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                {products.map((product) => (
                    ...
                    >
                        ...
                        <div>
                            <label htmlFor="">{product.quantity > 1 ? product.quantity : "Out of stock"}</label>
                        </div>

                        <button className="float-end bg-teal-800 rounded-full px-2 py-2 text-white">Add to Cart</button>
